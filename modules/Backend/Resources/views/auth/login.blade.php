...
<html>
	<head>
		...
		<!-- iCheck -->
		{!!Html::style('public/modules/backend/plugins/iCheck/square/blue.css')!!}
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="login-box-body">
				...
				<div class="form-group has-feedback">
					{!!Form::email('email', Input::get('email'), ['class'=>'form-control','placeholder'=>'Username'])!!}
		...
		<!-- iCheck -->
		{!!Html::script('public/modules/backend/plugins/iCheck/icheck.min.js')!!}
		<script>
			$(function () {
				$('input').iCheck({
